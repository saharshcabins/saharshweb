...
export default function ArchitectsPage() {
  ...
  return (
    <main className={styles.pageRoot}>
        ...
        >
          ...
          >
            ...
            <p className={styles.heroSub}>
              ...
              translate vision into structure â€” without substitution, without
        ...
        <div className={styles.trustInner}>
          <div className={styles.trustLeft}>
            ...
            <p className={styles.sectionBody}>
              We don&apos;t value-engineer the design to suit our process â€” we
              resource our process to honour your design. The geometry, the
              material palette, the proportions, the detailing â€” all of it is
            ...
            <div className={styles.pillarList}>
              <div className={styles.pillarItem}>
                ...
                <div className={styles.pillarText}>
                  ...
                  <p className={styles.pillarSub}>
                    Your drawings become our manufacturing brief â€” spatial
              ...
              <div className={styles.pillarItem}>
                ...
                <div className={styles.pillarText}>
                  ...
                  <p className={styles.pillarSub}>
                    DGU aluminium windows, hardwood cladding, bespoke finishes â€”
              ...
              <div className={styles.pillarItem}>
                ...
                <div className={styles.pillarText}>
                  ...
                  <p className={styles.pillarSub}>
                    You stay involved throughout â€” not just at brief and
          ...
          <div className={styles.showcaseBlock}>
            <Image
              ...
              alt="Saharsh Cabins â€” Qbinn Tusker Villa"
              fill
      ...
      {/* Partnership value strip â€” no commission, just craft */}
      <div className={styles.commissionStrip}>
        <div className={styles.commissionInner}>
          ...
          <span className={styles.commissionText}>
            ...
            <strong>Your design intent is our manufacturing brief</strong> â€” from
        ...
        <div className={styles.allianceGrid}>
          <div className={styles.allianceCard}>
            ...
            <p className={styles.allianceCardBody}>
              ...
              sketches. We study the intent, not just the dimensions â€” and
          ...
          <div className={styles.allianceCard}>
            ...
            <p className={styles.allianceCardBody}>
              ...
              milestone â€” and flag any material or structural decision that
          ...
          <div className={styles.allianceCard}>
            ...
            <p className={styles.allianceCardBody}>
              ...
              standard we hold ourselves to â€” and the conversation we welcome
              at every handover.
            </p>
          </div>
        </div>
      ...
      <section className={styles.testimonialSection}>
        <div className={styles.testimonialInner}>
          ...
          <blockquote className={styles.testimonialQuote}>
            ...
            absolute precision â€” every material we specified arrived on site,
        ...
        <div className={styles.formWrapper}>
          <div className={styles.formIntro}>
            ...
            <p className={styles.formSubtext}>
              ...
              projects. This is a working partnership â€” no referral
            ...
            >
              ...
              <div className={styles.formRow}>
                <textarea
                  id="message"
                  name="message"
                  placeholder="Tell us about your current or upcoming project â€” what you're designing, the brief, and what you're hoping a manufacturing partner can deliver..."
