  ...
  return (
    <main className={styles.pageRoot}>
      ...
      <section className={styles.hero}>
        ...
        >
          ...
          >
            ...
            <p className={styles.heroSub}>
              ...
              translate vision into structure &mdash;” without substitution, without
        ...
        >
          PREFERRED PARTNER &mdash;” OUTDOORS BY MARRIOTT BONVOY
        </div>
      </section>
        ...
        <div className={styles.trustInner}>
          <div className={styles.trustLeft}>
            ...
            <p className={styles.sectionBody}>
              We don&apos;t value-engineer the design to suit our process &mdash;” we
              resource our process to honour your design. The geometry, the
              material palette, the proportions, the detailing &mdash;” all of it is
            ...
            <div className={styles.pillarList}>
              <div className={styles.pillarItem}>
                ...
                <div className={styles.pillarText}>
                  ...
                  <p className={styles.pillarSub}>
                    Your drawings become our manufacturing brief &mdash;” spatial
              ...
              <div className={styles.pillarItem}>
                ...
                <div className={styles.pillarText}>
                  ...
                  <p className={styles.pillarSub}>
                    DGU aluminium windows, hardwood cladding, bespoke finishes &mdash;”
              ...
              <div className={styles.pillarItem}>
                ...
                <div className={styles.pillarText}>
                  ...
                  <p className={styles.pillarSub}>
                    You stay involved throughout &mdash;” not just at brief and
          ...
          <div className={styles.showcaseBlock}>
            <Image
              ...
              alt="Saharsh Cabins &mdash;” Qbinn Tusker Villa"
              fill
      ...
      {/* Partnership value strip &mdash;” no commission, just craft */}
      <div className={styles.commissionStrip}>
        <div className={styles.commissionInner}>
          ...
          <span className={styles.commissionText}>
            ...
            <strong>Your design intent is our manufacturing brief</strong> &mdash;” from
        ...
        <div className={styles.allianceGrid}>
          <div className={styles.allianceCard}>
            ...
            <p className={styles.allianceCardBody}>
              ...
              sketches. We study the intent, not just the dimensions &mdash;” and
          ...
          <div className={styles.allianceCard}>
            ...
            <p className={styles.allianceCardBody}>
              ...
              milestone &mdash;” and flag any material or structural decision that
          ...
          <div className={styles.allianceCard}>
            ...
            <p className={styles.allianceCardBody}>
              ...
              standard we hold ourselves to &mdash;” and the conversation we welcome
              at every handover.
            </p>
          </div>
        </div>
      ...
      <section className={styles.testimonialSection}>
        <div className={styles.testimonialInner}>
          ...
          <blockquote className={styles.testimonialQuote}>
            ...
            absolute precision &mdash;” every material we specified arrived on site,
          ...
          <div className={styles.testimonialMeta}>
            <span className={styles.testimonialAuthor}>
              &mdash;” Principal Architect, Bangalore Design Studio
            </span>
        ...
        <div className={styles.formWrapper}>
          <div className={styles.formIntro}>
            ...
            <p className={styles.formSubtext}>
              ...
              projects. This is a working partnership &mdash;” no referral
            ...
            >
              ...
              <div className={styles.formRow}>
                <textarea
                  id="message"
                  name="message"
                  placeholder="Tell us about your current or upcoming project &mdash;” what you're designing, the brief, and what you're hoping a manufacturing partner can deliver..."
              ...
              <div className="pb-[100px] md:pb-0" style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: 32, gap: 12 }}>
                <Button
                  text={status === "loading" ? "Submitting&hellip;" : "Submit Brief"}
