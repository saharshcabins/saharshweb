...
export function BackButton() {
  ...
  useEffect(() => {
    if (typeof document !== "undefined") {
      ...
      if (referrer.includes("/ourprojects")) {
  ...
  return (
    <div
      onClick={handleBack}
      className="flex items-center gap-2 mb-5 cursor-pointer w-fit  transition"
    >
      {/* <ArrowLeft size={18} />
  ...
  return (
    <nav className="flex items-center gap-2 mb-5">
      ...
      <div className="hidden lg:flex items-center gap-2">
        ...
        {/* <Link href="/ourprojects" className="hover:underline">
  ...
  return (
    <div className="mb-5">
      ...
      <div className="hidden lg:block">
        <TextBuilder fontSize="15px" color="dark">
          {product.location}
        </TextBuilder>
      </div>
      <div className="block lg:hidden">
        <TextBuilderMobile fontSize="13px" color="dark">
          {product.location}
        </TextBuilderMobile>
      </div>
    </div>
  ...
  return (
    <div className="flex flex-wrap gap-2 mt-4">
      {features.map((f) => (
        ...
        >
          <span className="hidden lg:block">
            <TextBuilder fontSize="12px" color="dark" weight="medium">
              {f}
            </TextBuilder>
          </span>
          <span className="block lg:hidden">
            <TextBuilderMobile fontSize="11px" color="dark" weight="medium">
              {f}
            </TextBuilderMobile>
          </span>
        </span>
...
export function Divider() {
  return (
    <hr style={{ borderColor: "var(--light-border)", margin: "32px 0" }} />
  );
}
