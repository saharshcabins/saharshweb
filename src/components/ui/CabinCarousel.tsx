...
const CabinCarousel = () => {
  ...
  return (
    <>
    {/* ==========================================
       HOME SECTION: SIGNATURE COLLECTIONS
       Purpose:
       Feature the brand's most recognised and in-demand cabin models by name.
       Primary conversion objective:
       Drive recognition and shortlist intent — get the buyer to picture a specific unit.
    ========================================== */}
    <section
    ...
    >
      ...
      <MultiColorText
        fontSize="75px"
        items={[
          { text: "Our Most Requested ", color: "dark", weight: "bold" },
          { text: "Designs", color: "primary", weight: "bold" },
        ]}
      />
